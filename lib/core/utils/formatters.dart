...
class Fmt {
  static String hex16(int v) => '0x${v.toRadixString(16).padLeft(4, '0').toUpperCase()}';
  static String hex8(int v) => '0x${v.toRadixString(16).padLeft(2, '0').toUpperCase()}';
  static String hex32(int v) => '0x${v.toRadixString(16).padLeft(8, '0').toUpperCase()}';
  ...
  /// USB configuration bmAttributes interpretation (USB 2.0):
  ...
  /// Human label for common Android MotionEvent axes.
  /// Values match Android MotionEvent constants (commonly used subset).
